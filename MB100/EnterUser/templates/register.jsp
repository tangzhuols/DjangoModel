...
-->
  ...
  */
    ...
    */
	...
	<script type="text/javascript" src="../static/assets/js/dt.js"></script>
	<body bgcolor="#F9F9F9">

		<form name="form1" method="post" action="../IndexEnroll/" onSubmit="return check()">
{% csrf_token %}
			<img src="../static/image/1.gif" width="14" height="11">
				...
				<tbody>
					...
					<tr>
						<td height="23" align="right" valign="middle"
							class="index-12at0 STYLE6 STYLE8">
							用户密码：						</td>
						<td><input id="userPwd" name="userPwd" class="aide" maxlength="16"
					...
					<tr>
						<td height="23" align="right" valign="middle"
							class="index-12at0 STYLE6 STYLE8">
							企业名称：						</td>
						<td colspan="2" valign="middle" align="left"><input id="nickname" name="deptName" maxlength="50" class="aide"
								size="44" type="text">
...
red;">*</span>						</td>
					...
					<tr>
						...
						<td colspan="2" align="left">
							<input name="deptType" class="aide" size="44" type="text">
					...
					<tr>
						...
						<td colspan="2" valign="middle" align="left"><span class="index-12at0" style="color: red;">
					      <label><span class="index-12at0" style="color: red;"><span class="index-12at0" style="color: red;">
					      <select name="resType" class="STYLE6" id="leibie">
                            <option>渠道型</option>
                            <option>拓展代理型</option>
                            <option>支撑型</option>
                            <option>营销资源型</option>
					...
					<tr>
						...
						<td colspan="2" valign="middle" align="left">
							<input name="mgtMode" maxlength="30" class="aide" size="44"
								type="text">
							<span class="index-12at0" style="color: red;">*</span>						</td>
					</tr>
					<tr>
						<td height="23" align="right" valign="middle"
							...
							成立时间：						</td>
						<td colspan="2" valign="middle" align="left">
							<input name="crtDate" maxlength="25" readonly="readonly"
								class="aide" size="44" type="text"
								onClick="getDateString(this,oCalendarChs)">
							<img src="<%=path%>/images/date.gif" width="13" height="20">
					...
					<tr>
						<td height="23" align="right" valign="middle"
							...
							公司人数：						</td>
						<td colspan="2" valign="middle" align="left">
							<input name="peopNum" maxlength="10" class="aide" size="44"
								type="text">
							<span class="index-12at0" style="color: red;">*</span>						</td>
					</tr>
					<tr>
						<td height="23" align="right" valign="middle"
							...
							品牌名称：						</td>
						<td colspan="2" valign="middle" align="left">
							<input name="brandName" maxlength="10" class="aide" size="44"
								type="text">
							<span class="index-12at0" style="color: red;">*</span>						</td>
					</tr>
					<tr>
						<td height="23" align="right" valign="middle"
							...
							管理体系认证：						</td>
						<td colspan="2" valign="middle" align="left">
							<input name="mngType" maxlength="10" class="aide" size="44"
								type="text">
							<span class="index-12at0" style="color: red;">*</span>						</td>
					</tr>
					<tr>
						<td height="23" align="right" valign="middle"
							...
							主要市场：						</td>
						<td colspan="2" valign="middle" align="left">
							<input name="manMkt" maxlength="30" class="aide" size="44"
								type="text">
							<span class="index-12at0" style="color: red;">*</span>						</td>
					</tr>
					<tr>
						...
						<td colspan="2" valign="middle" align="left">
							<span class="index-12at0" style="color: red;"> <input
									name="deptAddr" maxlength="30" class="aide" size="44"
									type="text"> *</span>						</td>
					</tr>
					<tr>
						<td height="23" align="right" valign="middle"
					...
					<tr>
						<td height="23" align="right" valign="middle"
							...
							负责人姓名：						</td>
						<td colspan="2" valign="middle" align="left">
							<input name="principalName" maxlength="10" class="aide" size="44"
								type="text">
							<span class="index-12at0" style="color: red;">*</span>						</td>
					</tr>
					<tr>
						<td height="23" align="right" valign="middle"
							...
							负责人电话：						</td>
						<td colspan="2" valign="middle" align="left">
							<input name="principalTel" maxlength="30" class="aide" size="44"
								id="tel" type="text">
							<span class="index-12at0" style="color: red;">*</span>						</td>
					</tr>
					<tr>
						<td height="23" align="right" valign="middle"
							...
							负责人手机：						</td>
						<td colspan="2" valign="middle" align="left">
							<input name="principalMtel" maxlength="25" class="aide" size="44"
								id="phone" type="text">
							<span class="index-12at0" style="color: red;">*</span>						</td>
					</tr>
					<tr>
						<td height="23" align="right" valign="middle"
							...
							营业执照号：						</td>
						<td colspan="2" valign="middle" align="left">
							<input name="businessNo" maxlength="25" class="aide" size="44"
								type="text">
							<span class="index-12at0" style="color: red;">*</span>						</td>
					</tr>
					<tr>
						<td height="23" align="right" valign="middle"
							...
							注册地址：						</td>
						<td colspan="2" valign="middle" align="left">
							<input name="regAddr" maxlength="25" class="aide"
								size="44" type="text">
							<span class="index-12at0" style="color: red;">*</span>						</td>
					</tr>
					<tr>
						<td height="23" align="right" valign="middle"
							...
							税务登记号：						</td>
						<td colspan="2" valign="middle" align="left">
							<input name="taxRegNo" maxlength="25" class="aide" size="44"
								type="text">
							<span class="index-12at0" style="color: red;">*</span>						</td>
					</tr>
					<tr>
						<td align="right" valign="middle"
							...
							企业简介：						</td>
						<td colspan="2" valign="middle" align="left">
							<textarea name="deptBrief" cols="35" rows="2" class="aide"></textarea>
							<span class="index-12at0" style="color: red;">*</span>						</td>
					</tr>
					<tr>
						<td height="23" align="right" valign="middle"
                	...
                	<tr>
						<td height="23" align="right" valign="middle"
							...
							邮件地址：						</td>
						<td colspan="2" valign="middle" align="left">
							<input name="email1" id="email" maxlength="30" class="aide"
								size="44" type="text">
							<span class="index-12at0" style="color: red;">*</span>						</td>
					</tr>
					<tr>
						<td colspan="3" class="index-12at0" valign="top" align="center"
							...
							<table width="45%" align="center" border="0" cellpadding="0"
								cellspacing="0">
								<tbody>
								<tr style=" color:#F00;">{{test}}</tr>
									<tr  width="45%" >
									<td valign="middle" align="left" width="45%">
											<input type="image" src="../static/image/ti-01.gif"
												width="61" height="26">
										</td>
										<td valign="middle" align="left" width="45%">
											<input type="image" src="../static/image/ti-02.gif"
												width="61" height="26">
										</td>
									</tr>
								</tbody>
